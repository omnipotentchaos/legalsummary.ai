...
[![Live Demo](https://legalsummary-ai.vercel.app/)
[![CI](https://github.com/omnipotentchaos/legalsummary.ai)]()
...
## 📸 Prototype Status (as of <MISSING_FIELD: date>)
...
```bash
git clone <MISSING_FIELD: repo_url>
cd legal-summary-ai
npm install   # or yarn
...
Automated health check (for judges):
curl -s <MISSING_FIELD: health_check_url> | jq
# Expected:
...
Solution
 LegalSummary-AI simplifies complex legal documents using Google Cloud Generative AI.
 Users upload a contract, optionally redact sensitive data, and receive plain-language clause summaries, risk flags, and actionable guidance in their preferred language.
 A Clause Dictionary ensures consistent explanations across documents, reducing cost and improving reliability.
Impact
...
*Includes Document AI pages, Vertex AI calls, Cloud Run compute, and Firestore ops.
 Costs reduced by Clause Dictionary reuse and caching.
