  ...
  const translations = {
    en: {
      ...
      clauseTypes: {
        ...
        penalty: 'Penalty',
        notice: 'Notice',
        collateral: 'Collateral', // From your log output
        interest: 'Interest',     // From your backend logic
        default: 'Term',          // General Fallback
        use: 'Use of Property',   // From your log output
        assignment: 'Assignment', // From your log output
        repayment: 'Repayment',   // From your backend logic
        default: 'General'
      }
    },
    hi: {
    ...
    or: {
      ...
      clauseTypes: {
        ...
        notice: 'ନୋଟିସ',
        collateral: 'ସୁରକ୍ଷା',
        use: 'ସମ୍ପତ୍ତି ବ୍ୟବହାର',
        assignment: 'ନିର୍ଦ୍ଦେଶ',
        interest: 'ସୁଧ',
        default: 'ଡିଫଲ୍ଟ',
        repayment: 'ପରିଶୋଧ',
        default: 'ସର୍ତ୍ତ'
