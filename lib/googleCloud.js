...
try {
  if (projectId && credentials) {
    ...
    console.log('Speech-to-Text not configured - missing project ID or credentials');
  }
} catch (error) {
...
export { documentAI, languageClient, translateClient, vertexAI, cloudStorage, speechClient };
